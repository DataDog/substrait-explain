    ...
    match pair.as_rule() {
        Rule::reference => {
            ...
            Ok(Expression::Reference(Reference {
                index: inner_pair.as_str().parse().unwrap(), // Handle parse error better in production
            }))
        }
        Rule::literal => {
...
mod tests {
    ...
    fn test_parse_field_reference() {
        assert_parses_to("$0", Expression::Reference(Reference { index: 0 }));
        assert_parses_to("$123", Expression::Reference(Reference { index: 123 }));
    }
    ...
    fn test_parse_function_call_with_simple_arguments() {
        assert_parses_to(
            ...
            Expression::FunctionCall(Box::new(FunctionCall {
                ...
                uri_anchor: None,
                arguments: vec![
                    Expression::Reference(Reference { index: 0 }),
        ...
        assert_parses_to(
            ...
            Expression::FunctionCall(Box::new(FunctionCall {
                ...
                arguments: vec![
                    ...
                    Expression::Reference(Reference { index: 1 }),
                ],
            })),
        );
    }
    ...
    fn test_parse_function_call_with_whitespace_and_mixed_optionals() {
        assert_parses_to(
            ...
            Expression::FunctionCall(Box::new(FunctionCall {
                ...
                uri_anchor: None,
                arguments: vec![
                    Expression::Reference(Reference { index: 5 }),
                    Expression::FunctionCall(Box::new(FunctionCall {
