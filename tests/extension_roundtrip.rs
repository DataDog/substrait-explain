...
use substrait_explain::extensions::{
    ArgsAccess, EnumValue, Explainable, Expr, ExtensionArgs, ExtensionColumn, ExtensionContext,
    ExtensionError, ExtensionProtoConvert, ExtensionRegistry, ExtensionValue, TupleValue,
};
...
fn test_tuple_sort_hint_from_args_rejects_non_tuple() {
    ...
    let result = registry.parse_enhancement("TupleSortHint", &args);
    assert!(
        result.is_err(),
